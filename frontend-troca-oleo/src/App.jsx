...
export default function App() {
  ...
  // Controle de visualização da tabela ('TODOS' | 'LEMBRETES_PENDENTES')
    ...
    <div className="min-h-screen bg-slate-100 font-sans pb-10">
      ...
      <header className="bg-slate-900 border-b-4 border-yellow-500 text-white shadow-xl mb-8">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-slate-800 border border-slate-700 px-4 py-2 rounded-lg text-xs font-bold text-slate-200 shadow-inner">
            <ShieldCheck size={18} className="text-emerald-400" />
            <span>MÓDULO DE BALCÃO ATIVO</span>
          </div>
